...
namespace Demo.PrimitiveBatch
{
    public class Game1 : Game
    {
        ...
        // primitive batch for the polygon
        private PrimitiveBatch<VertexPositionColor> _primitiveBatchPositionColor;
        // primitive batch for the sprite
        private PrimitiveBatch<VertexPositionColorTexture> _primitiveBatchPositionColorTexture;

        // a material for the polygon
        private Material<BasicEffect> _basicMaterial;
        // a material for the sprite
        private SpriteMaterial<BasicEffect> _spriteMaterial; 
        ...
        protected override void LoadContent()
        {
            ...
            // create the materials used for drawing
            _basicMaterial = new Material<BasicEffect>(basicEffect);
            _spriteMaterial = new SpriteMaterial<BasicEffect>(basicEffect, Content.Load<Texture2D>("logo-square-128"));
            ...
            // TriangleList is by far the most common way to have vertices layed out in memory for uploading to the GPU these days
            var vertices = new[]
            {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            var basicEffect = _basicMaterial.Effect;
            ...
            _primitiveBatchPositionColor.DrawPolygonMesh(_basicMaterial, _polygonMesh);
