...
namespace MonoGame.Extended.Tiled
{
    public class TiledObject : ITiledAnimated
    {
        ...
        public TiledObject(TiledObjectType objectType, int id, int? gid, IShapeF shape, float x, float y,
            TiledTilesetTile tilesetTile = null)
            : this(objectType, id, gid, shape, new Vector2(x, y), tilesetTile)
        {
        }

        public TiledObject(TiledObjectType objectType, int id, int? gid, IShapeF shape, Vector2 position,
            TiledTilesetTile tilesetTile = null)
        {
