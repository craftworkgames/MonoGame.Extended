...
{
    public class SpriteBuilderPositionTextureU16 : GraphicsGeometryBuilder<VertexPositionTexture, ushort>
    {
        public SpriteBuilderPositionTextureU16()
        ...
        public unsafe void BuildSprite(ref Matrix2D transformMatrix, Texture2D texture, ref Rectangle sourceRectangle, FlipFlags flags = FlipFlags.None, float depth = 0)
        {
            if (texture == null)
            ...
            fixed (VertexPositionTexture* pointer = Vertices)
            {
        ...
        public unsafe void BuildSprite(ref Matrix2D transformMatrix, Texture2D texture, FlipFlags flags = FlipFlags.None, float depth = 0)
        {
            if (texture == null)
                throw new ArgumentNullException(nameof(texture));
