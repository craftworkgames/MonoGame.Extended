...
namespace MonoGame.Extended.SfpGui.Controls {
    public class TextBox2 : Control {
        ...
        public override Size GetContentSize (IGuiContext context) {
            ...
            var stringSize = (Size)font.MeasureString (Text ?? string.Empty).ToSize();
            return new Size ((int)stringSize.Width, (int)(stringSize.Height < font.Size ? font.Size : stringSize.Height));
        }
        ...
        private Rectangle GetCaretRectangle (TextInfo textInfo) {
            ...
            var offset = new Vector2 (0, font.Size * LineIndex);
            var caretRectangle = font.GetTextBounds ( textInfo.Position + offset, text.Substring (0, ColumnIndex));
