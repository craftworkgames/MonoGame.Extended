...
namespace MonoGame.Extended.SfpGui {
    public interface IGuiRenderer {
        ...
        void DrawText (DynamicSpriteFont font, string text, Vector2 position, Color color, Rectangle? clippingRectangle = null);
    ...
    public class GuiSpriteBatchRenderer : IGuiRenderer {
        ...
        public void DrawText (DynamicSpriteFont font, string text, Vector2 position, Color color, Rectangle? clippingRectangle = null) {
            //TODO: make the font clippable in SF+
