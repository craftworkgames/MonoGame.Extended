...
namespace MonoGame.Extended.Graphics
{
    ...
    public enum Batch2DSortMode : byte
    {
        ...
        ///     batching. When <see cref="DynamicBatch2D.End" /> is called, the merged draw commands are processed on a first come, first
        ...
        ///     <see cref="DynamicBatch2D.End" /> is called, the sorting takes place and then the merged draw commands are processed where
