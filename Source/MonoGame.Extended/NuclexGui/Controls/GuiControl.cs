...
namespace MonoGame.Extended.NuclexGui.Controls
{
    ...
    public partial class GuiControl
    {
        ...
        public Collection<GuiControl> Children
        {
        ...
        /// </remarks>
        private ParentingControlCollection _children;
        ...
        public void BringToFront()
        {
            ...
            {
                ParentingControlCollection siblings = control._parent._children;
        ...
        public RectangleF GetAbsoluteBounds()
        {
            ...
            { 
                ...
                RectangleF parentBounds = _parent.GetAbsoluteBounds();

                // Determine the controls absolute position based on the absolute
                // dimensions and position of the parent control
                RectangleF controlBounds = Bounds.ToOffset(parentBounds.Width, parentBounds.Height);
        ...
        internal protected GuiControl MouseOverControl
        {
            get { return _mouseOverControl; }
        }

        /// <summary>Control that currently captured incoming input</summary>
        internal protected GuiControl ActivatedControl
        {
