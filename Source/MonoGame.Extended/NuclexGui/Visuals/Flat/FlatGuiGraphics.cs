...
namespace MonoGame.Extended.NuclexGui.Visuals.Flat
{
    public partial class FlatGuiGraphics : IFlatGuiGraphics, IDisposable
    {
        ...
        public FlatGuiGraphics(ContentManager contentManager, Stream skinStream)
        {
            ...
            this._spriteBatch = new SpriteBatch(graphicsDeviceService.GraphicsDevice);
            this._contentManager = contentManager;
            this._openingLocator = new OpeningLocator();
            this._stringBuilder = new StringBuilder(64);
            this._scissorManager = new ScissorKeeper(this);
            this._rasterizerState = new RasterizerState()
            {
                ScissorTestEnable = true
            };
            this._fonts = new Dictionary<string, SpriteFont>();
            this._bitmaps = new Dictionary<string, Texture2D>();
            this._frames = new Dictionary<string, Frame>();
