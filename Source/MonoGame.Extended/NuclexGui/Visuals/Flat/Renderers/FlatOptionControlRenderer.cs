...
namespace MonoGame.Extended.NuclexGui.Visuals.Flat.Renderers
{
    ...
    public class FlatOptionControlRenderer : IFlatControlRenderer<Controls.Desktop.GuiOptionControl>
    {
        /// <summary>
        ...
        /// </param>
        public void Render(Controls.Desktop.GuiOptionControl control, IFlatGuiGraphics graphics)
        {
