namespace MonoGame.Extended.NuclexGui.Visuals.Flat.Renderers
{
    ...
    public class FlatLabelControlRenderer : IFlatControlRenderer<Controls.GuiLabelControl>
    {
        /// <summary>
        ...
        /// </param>
        public void Render(Controls.GuiLabelControl control, IFlatGuiGraphics graphics)
        {
