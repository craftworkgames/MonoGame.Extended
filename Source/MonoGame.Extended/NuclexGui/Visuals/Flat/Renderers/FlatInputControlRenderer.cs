...
namespace MonoGame.Extended.NuclexGui.Visuals.Flat.Renderers
{
    ...
    public class FlatInputControlRenderer : IFlatControlRenderer<Controls.Desktop.GuiInputControl>, Controls.Desktop.IOpeningLocator
    {
        ...
        /// </param>
        public void Render(Controls.Desktop.GuiInputControl control, IFlatGuiGraphics graphics)
        {
