...
namespace MonoGame.Extended.NuclexGui.Visuals.Flat.Renderers
{
    ...
    public class FlatChoiceControlRenderer : IFlatControlRenderer<Controls.Desktop.GuiChoiceControl>
    {
        /// <summary>
        ...
        /// </param>
        public void Render(Controls.Desktop.GuiChoiceControl control, IFlatGuiGraphics graphics)
        {
