...
namespace MonoGame.Extended
{
    ...
    public interface IEquatableByReference<T>
    {
        /// <summary>Indicates whether the current value or object is equal to another value or object of the same type by reference.</summary>
        /// <returns><c>true</c> if the current value or object is equal to the <paramref name="other" /> parameter; otherwise, <c>false</c>.</returns>
