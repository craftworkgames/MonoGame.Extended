...
namespace MonoGame.Extended.ViewportAdapters
{
    ...
    public class BoxingViewportAdapter : ScalingViewportAdapter
    {
        ...
        private void OnClientSizeChanged(object sender, EventArgs eventArgs)
        {
            ...
            if (_graphicsDeviceManager != null && (_graphicsDeviceManager.PreferredBackBufferWidth != _window.ClientBounds.Width || _graphicsDeviceManager.PreferredBackBufferHeight != _window.ClientBounds.Height))
            {
