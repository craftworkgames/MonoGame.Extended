...
namespace MonoGame.Extended.InputListeners
{
    ...
    public class GamePadEventArgs : EventArgs
    {
        ...
        internal GamePadEventArgs(GamePadState previousState, GamePadState currentState, TimeSpan elapsedTime, PlayerIndex playerIndex, Buttons? button = null, float triggerState = 0, Vector2? thumbStickState = null)
        {
