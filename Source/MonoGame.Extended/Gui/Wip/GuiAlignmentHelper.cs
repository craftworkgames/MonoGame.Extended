...
namespace MonoGame.Extended.Gui.Wip
{
    ...
    {
        public static Rectangle GetDestinationRectangle(GuiHorizontalAlignment horizontalAlignment, GuiVerticalAlignment verticalAlignment, 
            Rectangle sourceRectangle, Rectangle targetRectangle)
        {
            ...
            var width = horizontalAlignment == GuiHorizontalAlignment.Stretch ? targetRectangle.Width : sourceRectangle.Width;
            var height = verticalAlignment == GuiVerticalAlignment.Stretch ? targetRectangle.Height : sourceRectangle.Height;
            return new Rectangle(x, y, width, height);
        }

        public static int GetHorizontalPosition(GuiHorizontalAlignment horizontalAlignment, Rectangle sourceRectangle, Rectangle targetRectangle)
        {
        ...
        public static int GetVerticalPosition(GuiVerticalAlignment verticalAlignment, Rectangle sourceRectangle, Rectangle targetRectangle)
        {
