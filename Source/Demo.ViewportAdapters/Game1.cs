...
namespace Demo.ViewportAdapters
{
    public class Game1 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.DrawString(_bitmapFont, $"Press D: {typeof (DefaultViewportAdapter).Name}",
                new Vector2(5, 5), Color.White);

            _spriteBatch.DrawString(_bitmapFont, $"Press S: {typeof (ScalingViewportAdapter).Name}",
                new Vector2(5, 5 + _bitmapFont.LineHeight * 1), Color.White);

            _spriteBatch.DrawString(_bitmapFont, $"Press B: {typeof (BoxingViewportAdapter).Name}",
                new Vector2(5, 5 + _bitmapFont.LineHeight * 2), Color.White);

            _spriteBatch.DrawString(_bitmapFont, $"Current: {_currentViewportAdapter.GetType().Name}",
            ...
            _spriteBatch.DrawString(_bitmapFont, $"Mouse: {_mousePosition}",
