...
internal sealed class OgmoTilemapImporter : ContentImporter<TilemapProjectContentItem>
{
    ...
    private static void RegisterTilesetDependencies(
        OgmoProject project,
    ...
    private static void DiscoverAndRegisterLevelFiles(
        OgmoProject project,
        string sourceDirectory,
        ContentImporterContext context,
        Dictionary<string, OgmoLevel> discoveredLevels)
    {
    ...
    private static List<TilemapData> ConvertLevels(
        OgmoProject project,
        Dictionary<string, OgmoLevel> discoveredLevels)
    {
