...
internal static class LDtkImportHelper
{
    ...
    internal static void RegisterTilesetDependencies(
        LDtkProject project,
    ...
    internal static void LoadExternalLevels(
        LDtkProject project,
        string sourceDirectory,
        ContentImporterContext context,
        Dictionary<string, LDtkLevel> resolvedLevels)
    {
    ...
    internal static List<TilemapData> ConvertLevels(
        LDtkProject project,
        Dictionary<string, LDtkLevel> resolvedExternalLevels)
    {
